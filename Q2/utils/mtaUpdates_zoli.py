...
class mtaUpdates(object):
    ...
    def getTripUpdates(self):
		...
		for x in entity.trip_update.stop_time_update:
			temp.update({x.stop_id : {"arrivalTime" : x.arrival.time , "departureTime" : x.departure.time}})
		update.futureStops = temp
		# Access future stops like: item.futureStops[StopStr]['arrivalTime']
		update.timeStamp    = timestamp
            ...
            if entity.vehicle and entity.vehicle.trip.trip_id:
                ...
                v.vehicleTimestamp         = entity.vehicle.timestamp
