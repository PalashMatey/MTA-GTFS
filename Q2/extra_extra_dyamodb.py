...
def findTrain():
	...
	if direction == "downtown":
		...
		print "Local train: " + str(next1_id)
		print "Express train: " + str(next23_id)
		print "Estimated travel time to/from 42nd on" +  str(next1_id)+" train " + str(round((arrivalTime1-time.time())/60.0,2))
                print "Estimated travel time to/from 42nd switching to  2 or 3 Train: " + str(round((arrivalTime23-time.time())/60.0,2))
